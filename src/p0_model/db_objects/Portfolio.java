...
public class Portfolio {
	...
	private double yield_full;
	private double risk_full;
	private double yield_share;
	private double risk_share;
	private double yield_comm;
	private double risk_comm;
	private double risk_asset_preview;
	private double yield_asset_preview;
	...
	public void setSigma_asset_preview(double sigma_asset_preview) {
		this.yield_asset_preview = sigma_asset_preview;
	}
	...
	public String toString() {
		return "Portfolio [portfolio_id=" + portfolio_id + ", name=" + name + ", user_id=" + user_id + ", investment="
				...
				+ ", estate_dist=" + estate_dist + ", bond_dist=" + bond_dist + ", sigma_full=" + yield_full
				+ ", risk_full=" + risk_full + ", sigma_share=" + yield_share + ", risk_share=" + risk_share
				+ ", sigma_comm=" + yield_comm + ", risk_comm=" + risk_comm + "]";
	}
